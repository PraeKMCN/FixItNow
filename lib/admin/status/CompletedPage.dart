...
import 'package:tes/admin/status/completedt.dart';


class Completed extends StatefulWidget {
  const Completed({Key? key, required Map data}) : super(key: key);
...
class _CompletedState extends State<Completed> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      // appBar: AppBar(
      //   title: const Text("คำร้องที่เสร็จสิ้นแล้ว"),
      ...
      return Card(
        child: ListTile(
          ...
          onTap: () {
            ...
            Navigator.of(context).push(MaterialPageRoute(builder: (context) =>Completeddetail(data: data)));
          },
        ),
      );
    } else {
